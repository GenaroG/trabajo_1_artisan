...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    <header class="app-header navbar">
        ...
        <ul class="nav navbar-nav d-md-down-none">
            <li class="nav-item px-3">                
                <a class="nav-link" onclick="redireccionar('escritorio')">Escritorio</a>
            </li>
            <li class="nav-item px-3">
                <a class="nav-link" onclick="redireccionar('configuraciones')">Configuraciones</a>
            </li>
        </ul>
    ...
    <div class="app-body">
        <div class="sidebar">
            <nav class="sidebar-nav">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link active" href="/escritorio"><i class="icon-speedometer"></i> Escritorio</a>
                    </li>
                    <li class="nav-title">
                        Mantenimiento
                    </li>
        ...
        <!-- Contenido Principal 
        con yield le mandamos a hablar a la vista.-->
        @yield('contenido')
        <!--@yield('$values["id"]');-->
    ...
    <script>
        function redireccionar(valor){location.href="/"+valor;} 
    </script>
</body>
